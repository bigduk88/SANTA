...
public class AttendedBoardDto {
    ...
    public AttendedBoardDto(Long id, String title, String board_imgUrl, String location, LocalDateTime meetTime, LocalDateTime createdAt, int people_current, int people_max, boolean deadlineStatus) {
        this.id = id;
