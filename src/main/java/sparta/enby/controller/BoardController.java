...
public class BoardController {
    ...
    public ResponseEntity getBaordList() {
    ...
    public ResponseEntity editBoard(@PathVariable Long board_id, @AuthenticationPrincipal UserDetailsImpl userDetails) throws IOException {
        return boardService.editBoard(board_id, boardRequestDto, userDetails)
    }

    // 게시글 삭제
    @DeleteMapping("/board/mating/{board_id}")
    public ResposeEntity deleteBoard(@PathVariable Long board_id, @AuthenticationPrincipal UserDetailsImpl userDetails) {
